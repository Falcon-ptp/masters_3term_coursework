...
Использую портфель, оптимизированный минимизацией \textit{CVaR}. 
...
Таким образом, все три модели позволяют адекватно оценить риски и предсказать поведение портфеля лучше, чем обычный эмпирический метод. Также описаны дальнейшие направления исследования. \\
\begin{center}
    \textbf{Abstract}
\end{center}
\begin{english}
...
Thus, all three models have superior prediction ability than a usual empirical method. 
